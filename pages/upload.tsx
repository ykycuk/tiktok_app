...
const Upload = () => {
  ...
  return (
    ...
    justify-center'>
        ...
        w-[60%] flex gap-6 flex-wrap justify-between items-center
        p-14 pt-6'>
            <div>
                <div>
                    <p className='text-2xl font-bold'>Upload Video</p>
                    <p className='text-md text-gray-400 mt-1'>Poat a video to your account</p>
                </div>
                            ...
                            {videoAsset ? (
                                ...
                                <label className='cursor-pointer'>
                                    ...
                                    h-full'>
                                        ...
                                        text-center mt-10 text-sm leading-10'>
                                            MP4 or WebM or ogg <br />
                                            720x1280 or higher <br />
                                            Up to 10 minutes <br />
                                            Less than 2GB
                                        </p>
                                        <p className='bg-[#F51997] text-center
                                        mt-10 rounded text-white text-md font-medium
            ...
            <div className='flex flex-col gap-3 pb-10'>
                ...
                font-medium'>Choose a Category</label>
                <select
                    onChange={(e) => setCategory(e.target.value)}
                    className="outline-none border-2
                    border-gray-200 text-md capitalize
                    lg:p-4 p-2 rounded cursor-pointer bg-white"
                >
                    {topics.map((topic) => (
                        <option
                            key={topic.name}
